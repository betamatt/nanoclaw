...
export const TAILSCALE_SOCKET = process.env.TAILSCALE_SOCKET || sdlcEnv.TAILSCALE_SOCKET || '';
...
export const SDLC_MAX_HEAVY_CONTAINERS = Math.max(
  1,
  parseInt(
    process.env.SDLC_MAX_HEAVY_CONTAINERS || sdlcEnv.SDLC_MAX_HEAVY_CONTAINERS || String(MAX_CONCURRENT_CONTAINERS - 1),
    10,
