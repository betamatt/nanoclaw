...
async function buildContainerArgs(
  ...
  // Pass GitHub credentials as env vars (gh CLI needs them directly)
  const ghEnv = readEnvFile(['GITHUB_TOKEN', 'GH_REPO']);
  for (const [key, value] of Object.entries(ghEnv)) {
...
export async function runContainerAgent(
  ...
  // Main group and SDLC groups use the default OneCLI agent;
  // others use their own agent.
  const isSdlc = group.folder.startsWith('sdlc-');
